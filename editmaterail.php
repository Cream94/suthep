<?php
  ...
  $id = $_GET["id"];
  $sql = "SELECT * FROM materail WHERE mat_id = $id";
      ...
      <center>
        <div class="row">
          <div class="col-md-6 col-md-offset-3 jumbotron well">
            ...
            <form class="form-horizontal" action="action/materail_edit.php?id=<?php echo $id;?>" method="post">
        ...
        <a href="materail.php" class="btn btn-danger">Cancel</a>
