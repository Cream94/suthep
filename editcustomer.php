      ...
      <center>
        <div class="row">
          <div class="col-md-6 col-md-offset-3 jumbotron well">
            ...
            <div class="col-sm-10">
            <input type="price" class="form-control" id="price" name="cust_tel" value="<?php echo $row["cust_tel"]; ?>" placeholder="เบอร์โทร">
            </div>
            </div>
            <div class="form-group">
            <label for="cust_fax" class="col-sm-2 control-label">เบอร์แฟ๊กซ์</label>
            <div class="col-sm-10">
            <input type="weight" class="form-control" id="weight" name="cust_fax" value="<?php echo $row["cust_fax"]; ?>" placeholder="เบอร์แฟ๊กซ์">
            </div>
            </div>
            <div class="form-group">
