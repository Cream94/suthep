      ...
      <center>
        <div class="row">
          <div class="col-md-6 col-md-offset-3 jumbotron well">
            ...
            <div class="col-sm-10">
            <input type="unit" class="form-control" id="unit" name="unit" value="<?php echo $row["unit"]; ?>" placeholder="หน่วยนับ">
            </div>
            </div>
            <div class="form-group">
            <label for="price" class="col-sm-2 control-label">ราคาวัตถุดิบ</label>
            <div class="col-sm-10">
            <input type="number" class="form-control" id="price" name="price" value="<?php echo $row["price"]; ?>" placeholder="ราคาวัตถุดิบ">
            </div>
            </div>
            <div class="form-group">
