...
<form class="form-inline">
  <div class="form-group">
    <label for="admin_name">ชื่อพนักงาน</label>
    <input type="text" name="search" class="form-control" id="admin_name" placeholder="ชื่อพนักงาน" value="<?=$search;?>">
  </div>
  <button type="submit" class="btn btn-info">ค้นหา</button>
  <a href="adduser.php" class="btn btn-success">เพิ่ม</a>
  ...
  <?php
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      echo '<td align="center">
                <a href="edituser.php?id='.$id.'" class="btn btn-default btn-sm">แก้ไข</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">รายละเอียดข้อมูลพนักงาน</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="formModal" action="" method="post">
          <div class="form-group">
            <label for="admin_id" class="col-sm-2 control-label">รหัสพนักงาน</label>
          <div class="col-sm-4">
